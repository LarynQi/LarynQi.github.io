...
class IceCream:
    ...
    def __init__(self, flavor, temperature, scoops, new=True):
        ...
        ______________________________________ # (1) Update inventory with this ice cream
    ...
    def freeze(self):
        ...
        -1000
        """
        ________________________ # (2) Set to freezing point
    ...
    def heat(self, degrees):
        ...
        """
        _________________________________ # (3) Update temperature
    ...
    def melt(self):
        ...
        1000
        """
        self.temperature = ____________________________ # (4) Set to melting point
    ...
    def choose(self, craving=False):
        ...
        if self.picky or craving:
         # (6) How do we know we are out of their favorite flavor? Fill in the conditions.
            if ______________________________________ or ______________________________________:
            ...
            for flavor in ____________________________________:
                choices.extend(____________________________________)
